...
const aboutImg = "../images/background.png";
const myChatAvatar = "../images/sender.jpg";
const friendChatAvatar = "../images/reciever.jpg";
...
var recStartTime;
var recElapsedTime;
var swalBackground = "#1d2026"; // black - #16171b - transparent ...
  ...
  signalingSocket.on("addPeer", function (config) {
    ...
    peerConnections[peer_id].ontrack = function (event) {
      ...
      if (ontrackCount === 2) {
        ...
        remoteHandStatusIcon.style.setProperty("color", "#ff914d");
...
function setupLocalMedia(callback, errorback) {
  ...
  navigator.mediaDevices
    ...
    .then(function (stream) {
      ...
      myHandStatusIcon.style.setProperty("color", "#ff914d");
...
function disableAllPeers(element) {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    imageAlt: "Dogemeet-disable-" + element,
...
function getAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>Project made with ❤️</strong>",
    imageAlt: "Dogemeet-about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about">
    <p> Developers : Miroslav Pejic and Anshuman Mishra</p>
    <a href="https://github.com/anshuman2166AppproDev/Doge-Meet-Sources"><img src="../images/github.png" style="
    width: 200px;
